...
// WalkAll traverses a model depth-first and calls fn for every element.
// Use Walk when you need early termination.
func WalkAll(model *Model, fn func(elem Element, depth int)) {
